...
keymap("n", "<leader>sf", function()
    MiniSessions.select()
end, { noremap = true, silent = true, desc = "Load Session" })
...
end, { noremap = true, silent = true, desc = "Mini Map" })
